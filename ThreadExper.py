...
def update(val):
    ...
    if fillBetFigure is not None and fillAxis is not None:
        ...
        #get all values x that are less than the right slider, and greater than the left slider
...
class PageThree(tk.Frame):
    def __init__(self, parent, controller):
        ...
        muLabel = ttk.Label(buttContainer, textvariable = self.muVar, font = MED_FONT)
        muLabel.grid(sticky = "e", row = 8, column= 1, columnspan = 2, padx = 2, pady = 4)
